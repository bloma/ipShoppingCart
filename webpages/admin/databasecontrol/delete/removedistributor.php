<?php
    ...
    {
        $distributorObject = new Distributor();
    }
?>
<html>
    <head>
            ...
            <div id="innerWrapper">
                ...
                <div id="main">
                    ...
                    <div id="content" class="floatRight">
                        <form name="removeDistributor" action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
                            <p>Enter the ID of the distributor you want to remove: <input type="text" name="distributorID" value=""/></p>
                            <input type="submit" value="submit" name="deleteDistributor"/>
                        </form>
                        <?php
                            if(isset($_POST["deleteDistributor"]))
                            {
                                $id = $_POST["distributorID"];
                                if(is_numeric($id))
                                {
                                    $distributorObject->setDistributorID($id);
                                    $sqlFunctions->removeDistributor($conn,$distributorObject->getDistributorID());
                                }
                                else{
