                ...
                <div id="main">
                    ...
                    <div id="content" class="floatRight">
                        <form name="removeProduct" action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
                            <p>Enter the ID of the supplier you want to remove: <input type="text" name="supplierID" value=""/></p>
                            <input type="submit" value="submit" name="deleteSupplier"/>
                        </form>
                        <?php
                            if(isset($_POST["deleteSupplier"]))
                            {
                                ...
                                if(is_numeric($id))
                                {
                                    $supplierObject->setSupplierId($id);
                                    $sqlFunctions->removeSupplier($conn,$supplierObject->getSupplierId());
                                }
                                else{
