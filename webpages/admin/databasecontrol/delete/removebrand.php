            ...
            <div id="innerWrapper">
                ...
                <div id="main">
                    ...
                    <div id="content" class="floatRight">
                        <form name="removeBrand" action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
                            <p>Enter the ID of the brand you want to remove: <input type="text" name="brandID" value=""/></p>
                            <input type="submit" value="submit" name="deleteBrand"/>
                        </form>
                        <?php
                            if(isset($_POST["deleteBrand"]))
                            {
                                ...
                                if(is_numeric($id))
                                {
                                    $brandObject->setBrandId($id);
                                    $sqlFunctions->removeBrand($conn,$brandObject->getBrandId());
                                }
                                else{
