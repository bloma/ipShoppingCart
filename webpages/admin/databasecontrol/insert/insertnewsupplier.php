                    ...
                    <div class="content">
                        <ul class="sidebarList">
                            ...
                            else if(isset($_SESSION["loggedIn"]) && $accType == "Admin")
                            {
                                ...
                                echo "<li class='first'><a href='insertnewbrands.php'>Add Brand</a></li>";
                                echo "<li><a href='insertnewdistributors.php'>Add Distributor</a></li>";
                                echo "<li><a href='insertnewproduct.php'>Add Product</a></li>";
                                echo "<li><a class='last' href='insertnewsupplier.php'>Add Supplier</a></li>";
