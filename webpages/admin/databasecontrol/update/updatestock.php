                    ...
                    <div class="content">
                        <ul class="sidebarList">
                            ...
                            else if(isset($_SESSION["loggedIn"]) && $accType == "Admin")
                            {
                                ...
                                echo "<li class='first'><a href='../insert/insertnewbrands.php'>Add Brand</a></li>";
                                echo "<li><a href='../insert/insertnewdistributors.php'>Add Distributor</a></li>";
                                echo "<li><a href='../insert/insertnewproduct.php'>Add Product</a></li>";
                                echo "<li><a class='last' href='../../databasecontrol/insert/insertnewsupplier.php'>Add Supplier</a></li>";
                                echo "<h5>Update options</h5>";
                                echo "<li class='first'><a href='updatebrands.php'>Update Brand</a></li>";
                                echo "<li><a href='updatedistributors.php'>Update Distributor</a></li>";
                                echo "<li><a href='updatestock.php'>Update Stock</a></li>";
                                echo "<li><a class='last' href='updatesuppliers.php'>Update Supplier</a></li>";
                                echo "<h5>Delete Options</h5>";
                                echo "<li class='first'><a href='../delete/removebrand.php'>Delete Brand</a></li>";
                                echo "<li><a href='../delete/removedistributor.php'>Delete Distributor</a></li>";
                                echo "<li><a href='../delete/removeproduct.php'>Delete Product</a></li>";
                                echo "<li><a class='last' href='../delete/removesupplier.php'>Delete Supplier</a></li>";
                            }
